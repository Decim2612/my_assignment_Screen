...
enum class BottomNavigationItem(val icon: Int, val navDestination:DestinationScreen) {
    HOMELIST(R.drawable.home_icon, DestinationScreen.Home),
    MEALS(R.drawable.meals_icon,DestinationScreen.Home),
    NEARBY(R.drawable.nearby_icon, DestinationScreen.Home),
    PROFILE(R.drawable.user_icon, DestinationScreen.Home)
}
@Composable
